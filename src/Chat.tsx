...
export class Chat extends React.Component<ChatProps, {}> {
  ...
  constructor(props: ChatProps) {
    ...
    this.handleCompleteConfig = this.handleCompleteConfig.bind(this);
    ...
    switch (activity.type) {
      case 'message':
        ...
        if (!isUserMessage && this.typingActivity) {
          ...
          this.store.dispatch<ChatActions>({
            type: 'Clear_Typing',
            id: this.typingActivity.id
          });
        }

        this.store.dispatch<ChatActions>({
          type: isUserMessage ? 'Receive_Sent_Message' : 'Receive_Message',
          activity
        });
        break;
  ...
  private handleCompleteConfig(data: IDaimlerData) {
  ...
  componentDidMount() {
    ...
    initSignalR(this.props.user.id, this.handleCompleteConfig);
  }
