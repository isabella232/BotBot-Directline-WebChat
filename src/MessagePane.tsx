...
import { CardAction, User, Message } from 'botframework-directlinejs';
...
const MessagePaneView = (props: MessagePaneProps) => (
  <div
    className={classList('wc-message-pane', props.activityWithSuggestedActions && 'show-actions')}
  >
    {props.children}
...
function activityWithSuggestedActions(activities: MyActivity[]) {
